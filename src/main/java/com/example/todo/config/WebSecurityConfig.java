...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		 ...
		 * response.setStatus(HttpServletResponse.SC_FORBIDDEN); String message;
		 * if(e.getCause() != null) { message = e.getCause().getMessage(); } else {
		 * message = e.getMessage(); } byte[] body = new ObjectMapper()
